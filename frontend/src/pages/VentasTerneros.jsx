...
function VentasTerneros() {
  ...
  const cargarVentas = async () => {
    try {
      const response = await fetch('/api/ventas-terneros');
  ...
  const eliminarRegistro = async (id) => {
    ...
    try {
      const response = await fetch(`/api/ventas-terneros/${id}`, {
        method: 'DELETE'
      });
